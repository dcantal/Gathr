...
machinelearning = Event.create(name: "Machine learning: Trends, perspectives, and prospects @ Attune", address: "40 Exchange Pl, New York, NY 10005", description: "Come and learn for an exciting talk about Machine Learning! This exciting space will only grow bigger in the future and you should definitely add this knowledge to your repertoire ", group_id: wwc.id, start_time: DateTime.new(2019,5,3,20,0,0,Rational(-4,24)), end_time: DateTime.new(2019,5,3,22,0,0,Rational(-4,24)), latitude: 40.7057883, longitude: -74.0102498, private: FALSE)

algorithms = Event.create(name: "Algorithms@Betterment", address: "61 W 23rd St, New York, NY 10010", description: "Come for some algorithms practice ", group_id: wwc.id, start_time: DateTime.new(2019,5,10,20,0,0,Rational(-4,24)), end_time: DateTime.new(2019,5,10,22,0,0,Rational(-4,24)), latitude: 40.7426416, longitude: -73.9939997, private: FALSE)
...
thirdsocial = Event.create(name: "Third social gathering", address: "148 W 24th St, New York, NY 10011", description: "This will be the third social get together to discuss games over drinks. The poll was pretty conclusive that Barcade is the favored spot. I’ll leave the poll up, for those who want to suggest other places. I’m going to see if we get any more RSVPs tomorrow, but if not, will prob postpone - this might be a bad week, as I understand some might be on spring break and Wednesday’s may not work well.", group_id: game.id, start_time: DateTime.new(2019,5,3,20,0,0,Rational(-4,24)), end_time: DateTime.new(2019,5,3,22,0,0,Rational(-4,24)), latitude: 40.7443119, longitude: -73.9944248, private: FALSE)

fourthsocial = Event.create(name: "Fourth social gathering", address: "148 W 24th St, New York, NY 10011", description: "This will be the fourth social get together to discuss games over drinks. The poll was pretty conclusive that Barcade is the favored spot. I’ll leave the poll up, for those who want to suggest other places. I’m going to see if we get any more RSVPs tomorrow, but if not, will prob postpone - this might be a bad week, as I understand some might be on spring break and Wednesday’s may not work well.", group_id: game.id, start_time: DateTime.new(2019,5,10,20,0,0,Rational(-4,24)), end_time: DateTime.new(2019,5,10,22,0,0,Rational(-4,24)), latitude: 40.7443119, longitude: -73.9944248, private: FALSE)
